...
<head>
  ...
  <title>Admin Bathroom Boutique</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Bathroom Boutique</span>
      </a>
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <!--  <a href="#" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url('admin/data_sub_kategori') ?>" class="nav-link">
                  <i class="fa fa-window-maximize" aria-hidden="true"></i>
                  
                  <p>Data Sub Kategori Produk</p>
                </a>
              </li>


              <li class="nav-item">
                <a href="<?= base_url('admin/data_jenis_sub_kategori') ?>" class="nav-link">
                  <i class="fa fa-window-restore" aria-hidden="true"></i>
                  
                  <p>Data Jenis Sub Kategori Produk</p>
                </a>
              </li>
              

              <li class="nav-item">
                <a href="<?= base_url('admin/data_merek') ?>" class="nav-link">
